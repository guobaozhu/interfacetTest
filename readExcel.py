...
if __name__ == '__main__':  # 我们执行该文件测试一下是否可以正确获取Excel中的值
    print(readExcel().get_xls('userCase.xlsx', 'shop'))
    print(readExcel().get_xls('userCase.xlsx', 'shop')[0][0])
    print(readExcel().get_xls('userCase.xlsx', 'shop')[1][2])
    print(readExcel().get_xls('userCase.xlsx', 'shop')[1][3])
